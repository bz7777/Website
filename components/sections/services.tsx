...
const icons = [Globe, AppWindow, Palette, ShoppingCart, Search, Wrench, Bot]
...
export function Services() {
  ...
  return (
    <section id="services" className="py-24 px-6 bg-black/85">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="group p-6 rounded-2xl border border-white/10 bg-zinc-900 hover:bg-zinc-800 hover:border-violet-500/50 transition-all duration-300"
              >
